...
class ReplayBuffer:
    ...
    def sample(self, batch_size: int) -> Experience:
        ...
        return Experience(
            states, actions, rewards, next_states, dones, next_masks, next_turns
        )
...
def play_episode(env, agent1: MinMaxQAgent, agent2: MinMaxQAgent,
                 memory1: Optional[EpisodeMemory] = None,
                 memory2: Optional[EpisodeMemory] = None):
    """
...
def evaluate_agents(env, agent1: MinMaxQAgent, agent2: MinMaxQAgent,
